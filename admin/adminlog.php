			  ...
			  <div class="modal-dialog">
			    ...
			    <div class="modal-content">
			      <div class="modal-header">
			        ...
			        <h4 class="modal-title"><span class="glyphicon glyphicon-export"></span>Export Admin Logging</h4>
			      </div>
			      <div class="modal-body">
			      <form id="exportform" method="POST" action="asset/export.php?table=adminlog">
			      	<div class="form-group">
							<label for="exname">Export file name:</label>
						 <input type="text" class="form-control" name="ename" id="ename" value="adminlog<?php echo date('Y-m-d');?>">
					 </div>
					 <div class="form-group">
